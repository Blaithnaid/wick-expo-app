import { Text, View, Image, TouchableOpacity } from "@/components/Themed";
...
export default function HomeScreen() {
    ...
    return (
        <View className="flex-1 w-full px-5 py-4 bg-white">
            {/* Header Section */}
            ...
            <View className="mt-5">
                ...
                <View className="flex-row space-x-3 mt-2">
                    ...
                    <View className="bg-purple-500 p-4 rounded-lg w-[160px]">
                        <Text className="text-white font-semibold">Task Almost Complete!</Text>
